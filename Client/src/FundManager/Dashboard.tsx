            ...
            <div className="border-4 border-dashed border-gray-200 rounded-lg p-8 bg-white shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-blue-50 p-6 rounded-lg shadow">
                  ...
                  <p className="text-sm text-blue-600 mt-1">+1 this month</p>
                </div>
                ...
                <div className="bg-green-50 p-6 rounded-lg shadow">
                  ...
                  <p className="text-3xl font-bold text-green-900">$42.3M</p>
                ...
                <div className="bg-purple-50 p-6 rounded-lg shadow">
                  ...
                  <p className="text-sm text-purple-600 mt-1">+7 this month</p>
                </div>
              </div>
              ...
              <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                <div className="px-4 py-5 sm:px-6 bg-gray-50">
                  ...
                  <p className="mt-1 max-w-2xl text-sm text-gray-500">
                    Your account details and fund management information.
                  </p>
                </div>
