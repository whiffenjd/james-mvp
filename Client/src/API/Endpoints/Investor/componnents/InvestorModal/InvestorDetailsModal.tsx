...
export function InvestorDetailsModal({ investorId, isOpen, onClose, onApprove, onReject }: InvestorDetailsModalProps) {
    ...
    const formatJurisdiction = (jurisdiction: string) => {
        return jurisdiction.replace(/_/g, " ").replace(/\b\w/g, (l) => l.toUpperCase())
    }
    ...
    const renderJurisdictionSection = (formData: any) => (
        <div className="mb-8">
            <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Jurisdiction Selection</h3>
            </div>
            <div className="ml-11">
                <div className="mb-4">
    ...
    const renderInvestorCategorizationSection = (formData: any) => (
        <div className="mb-8">
            <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Investor Categorization</h3>
            </div>
            <div className="ml-11 space-y-6">
                {/* Individual Investor Type */}
                <div>
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Individual Investor Type</h4>
                ...
                {formData?.individualInvestorType === "high_net_worth" && formData?.highNetWorthQualification && (
                    <div>
                        <h4 className="text-sm font-medium text-gray-700 mb-3">High Net Worth Individual Qualification</h4>
                ...
                {/* Self Certified Sophisticated Investor */}
                {formData?.individualInvestorType === "self_certified_sophisticated_investor" &&
                    formData?.selfCertifiedSophisticatedInvestor && (
                        <div>
                            <h4 className="text-sm font-medium text-gray-700 mb-3">Self Certified Sophisticated Investor Details</h4>
                            <div className="space-y-3">
                                <div>
                                    <span className="text-sm text-gray-600">Professional Capacity</span>
                                    <div className="flex items-center space-x-2 mt-1">
                                        <div className="w-4 h-4 bg-gray-300 rounded-full flex items-center justify-center">
                                            <div className="w-2 h-2 bg-white rounded-full"></div>
                                        </div>
                                        <span className="text-sm text-gray-900">
                                            {formatBoolean(formData?.selfCertifiedSophisticatedInvestor?.professionalCapacity)}
                                        </span>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="flex items-center space-x-2 mt-1">
                                        ...
                                        <span className="text-sm text-gray-900">
                                            {formatBoolean(formData?.selfCertifiedSophisticatedInvestor?.director)}
                                        </span>
                                    </div>
                                </div>
                                <div>
                                    <span className="text-sm text-gray-600">Unlisted Investments</span>
                                    <div className="flex items-center space-x-2 mt-1">
                                        <div className="w-4 h-4 bg-gray-300 rounded-full flex items-center justify-center">
                                            <div className="w-2 h-2 bg-white rounded-full"></div>
                                        </div>
                                        <span className="text-sm text-gray-900">
                                            {formatBoolean(formData?.selfCertifiedSophisticatedInvestor?.unlistedInvestments)}
                                        </span>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="flex items-center space-x-2 mt-1">
                                        ...
                                        <span className="text-sm text-gray-900">
                                            {formatBoolean(formData?.selfCertifiedSophisticatedInvestor?.businessAngel)}
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    const renderDocumentsSection = (formData: any) => (
        <div className="mb-8">
            <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">AML/KYC Documents</h3>
            </div>
            <div className="ml-11">
            ...
            <div className="bg-theme-card rounded-lg shadow-xl max-w-4xl w-full max-h-[95vh] overflow-hidden">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    <div className="flex items-center space-x-4">
                        <div>
                            <h2 className="text-xl font-semibold text-theme-primary-text">Fund Manager</h2>
                            <p className="text-sm text-theme-secondary-text">Investor Onboarding Progress</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="overflow-y-auto max-h-[calc(90vh-140px)]">
                    {isLoading ? (
                        <div className="flex items-center justify-center py-12">
                            ...
                            <span className="ml-3 text-gray-600">Loading investor details...</span>
                        </div>
                    ) : error ? (
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-center justify-between mb-8 p-4 bg-gray-50 rounded-lg">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-gray-900">{data?.data?.userName || "John Smith"}</h3>
                                        <p className="text-sm text-gray-500">{data?.data?.userEmail}</p>
                                    </div>
                                </div>
                            ...
                            <ProgressBar
                                currentStep={2}
                                steps={["Jurisdiction Selection", "Investor Categorization", "AML/KYC Documents"]}
                            />
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                        <div className="bg-white rounded-xl shadow-lg p-6 max-w-sm w-full">
                            ...
                            <p className="text-gray-700 mb-4">
                                Are you sure you want to approve this investor? This action cannot be undone.
                            </p>
                ...
                {showRejectModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                        <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
                            ...
                            <p className="text-gray-700 mb-4">
                                Please provide a reason for rejecting this investor (minimum 10 characters).
                            </p>
