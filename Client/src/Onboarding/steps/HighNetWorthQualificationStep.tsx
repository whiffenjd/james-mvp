        ...
        <div className="p-2 mx-auto space-y-8">
            ...
            <div>
                ...
                <p className="secondary-heading">
                    If you meet condition <b>A</b> or <b>B</b> below, you may choose to be classified as a high net worth individual for the purposes of the Financial Services and Markets Act 2000 (Financial Promotion) Order 2005.
                </p>
            </div>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className=" border border-[#979797] rounded-xl p-5 space-y-4">
                    <div className="tertiary-heading">
                        (A) In the last financial year, did you have an annual income of £100,000 or more?
                        Income does NOT include any one-off pension withdrawals
                    </div>
                        ...
                        <div className="mt-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    min={0}
                                    step={10000}
                                    {...register("highNetWorthQualification.incomeAmount", { valueAsNumber: true })}
                                    placeholder="e.g. 100000"
                                    className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-[#2FB5B4] 
                                        ${errors.highNetWorthQualification?.incomeAmount ? 'border-red-500' : 'border-gray-300'}`}
                                />
                ...
                <div className=" border border-[#979797] rounded-xl p-5 space-y-4">
                    ...
                    {watched?.netAssetsQualified === "true" && !noneApply && (
                        <div className="mt-2">
                            <label className="tertiary-heading">
                                Please specify your net assets (as defined above) to the nearest £100,000 in the last financial year                            </label>
                            <input
                                type="number"
                                min={0}

                                {...register("highNetWorthQualification.netAssetsAmount", { valueAsNumber: true })}
                                placeholder="Specify your net assets (£), nearest £100,000"
                                className={`w-full p-2 border rounded outline-none focus:ring-2 focus:ring-[#2FB5B4] 
                                    ${errors.highNetWorthQualification?.netAssetsAmount ? 'border-red-500' : 'border-gray-300'}`}
                            />
